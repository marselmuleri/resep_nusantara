...
export default function RecipeGrid({ recipes, favorites = [], onToggleFavorite, onOpenDetail }) {
            ...
            >
              ...
              >
                ...
                <div className="relative h-32 md:h-56 overflow-hidden">
                  ...
                  {/* Favorite Button */}
                  <button
                    className={`absolute top-2 right-2 z-20 p-2 rounded-full bg-white/80 hover:bg-green-200 transition-colors ${isFavorite ? 'text-yellow-500' : 'text-gray-400'}`}
                    onClick={e => {
                      e.stopPropagation();
                  ...
                  >
                    <Star className={`w-5 h-5 ${isFavorite ? 'fill-yellow-400' : 'fill-none'}`} />
                  </button>
                </div>
